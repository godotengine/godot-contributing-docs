...
.. note::
  ...
  they are also usually unnecessarily verbose making it harder to read and understand issues written this way. Please see our
  :ref:`guidelines on AI use <doc_ai_assisted_contributions>` for more details.

  If you aren't comfortable with English, write your issue in your native language and use dedicated translation software (not a chat bot)
...
Follow these basic rules to make your MRP as clear and useful as possible.

**Don't:**

  - Require unnecessary extra steps or searching through the project to test it.
  - Upload exported projects, these are not helpful for testing what is wrong, and triagers should not run untrusted programs.
  - Add unnecessary content to the MRP, or remove parts that are needed to make the MRP work.
  - Upload resources that are not yours to share, or violate the license of resources.
  - Make an MRP that might cause damage to hardware or that might delete files or cause corruption.
  - Make MRPs for bugs related to exploits or potential security risks.
  - Upload an MRP without first confirming it reproduces the issue for you.

**Do:**

  - Make the project easy to test, when possible it should immediately replicate the bug when run, exported, or edited without additional changes or configuration.
  - Upload a complete, minimal project, containing everything needed and nothing else.
  - Only use resources and code you are allowed to share, and make sure to follow any licensing instructions if you upload resources or code you did not make.
  - Verify the MRP reproduces the bug for you before uploading it.
