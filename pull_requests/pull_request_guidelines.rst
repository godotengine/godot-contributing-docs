...
“Substantial code” is code that poses potential risks to quality and maintainability of the engine and is to be measured
on the basis of: the amount of code involved, its degree of complexity, the level of experience of the contributor in
the Godot project, the area of the codebase, and ultimately the risk of merging the code.
