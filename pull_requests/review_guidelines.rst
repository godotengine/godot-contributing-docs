...
If the pull request isn't sufficiently motivated, we recommend you stop your
...
You should read the pull request description, the linked issue or proposal,
...
Practically, the approval of :ref:`area maintainers <doc_areas>` are always needed
