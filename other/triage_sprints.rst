...
- Confirm that the report is filled in correctly, and that all the necessary details are available. See :ref:`this page <doc_issue_report_writing>` for a reference.
