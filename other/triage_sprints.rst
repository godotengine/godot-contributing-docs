...
- Confirm that the report is filled in correctly, that all the necessary details are available, see :ref:`this page <doc_issue_report_writing>` for a reference.
